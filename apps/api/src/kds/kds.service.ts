...
export class KdsService {
  ...
  async findTickets(query: KdsQueryDto) {
    ...
    const where: Prisma.OrderWhereInput = {
      // Only DRAFT orders are live kitchen tickets. A PAID/CANCELLED order may
      // still carry a stale kdsStage (it was sent to the kitchen before being
      // finalised); without this guard such orders would re-appear on the KDS
      // every time it refetches, even though they were removed in real time.
      status: 'DRAFT',
