...
export function Reports() {
  ...
  const [summary, setSummary] = useState<SummaryMetrics>({ totalOrders: 0, totalRevenue: 0, averageOrderValue: 0 });
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="nb-card p-5 border-2 border-black shadow-neubrutal-sm bg-white flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-black text-black mt-1 font-mono">₹{summary.totalRevenue.toFixed(2)}</p>
              </div>
            ...
            <div className="nb-card p-5 border-2 border-black shadow-neubrutal-sm bg-white flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-black text-black mt-1 font-mono">₹{summary.averageOrderValue.toFixed(2)}</p>
              </div>
                    ...
                    <div className="flex-1 overflow-y-auto max-h-60 grid grid-cols-1 gap-2 mt-4 sm:mt-0 px-4 font-bold text-xs uppercase select-none">
                      {categories.map((c, idx) => (
                        <div key={idx} className="flex items-center gap-2">
                          ...
                          <span className="font-mono text-neutral-600">₹{c.revenue.toFixed(2)}</span>
                        </div>
                      ))}
                    </div>
                  </>
